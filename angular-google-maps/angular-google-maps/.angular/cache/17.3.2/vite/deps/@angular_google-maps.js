...
var _MapAdvancedMarker = class _MapAdvancedMarker {
  /**
...
_MapAdvancedMarker.ɵfac = function MapAdvancedMarker_Factory(t) {
  return new (t || _MapAdvancedMarker)(ɵɵdirectiveInject(GoogleMap), ɵɵdirectiveInject(NgZone));
};
_MapAdvancedMarker.ɵdir = ɵɵdefineDirective({
...
var MapAdvancedMarker = _MapAdvancedMarker;
(() => {
...
_GoogleMapsModule.ɵmod = ɵɵdefineNgModule({
  ...
  imports: [GoogleMap, MapBaseLayer, MapBicyclingLayer, MapCircle, MapDirectionsRenderer, MapGroundOverlay, MapHeatmapLayer, MapInfoWindow, MapKmlLayer, MapMarker, MapAdvancedMarker, MapMarkerClusterer, MapPolygon, MapPolyline, MapRectangle, MapTrafficLayer, MapTransitLayer],
  exports: [GoogleMap, MapBaseLayer, MapBicyclingLayer, MapCircle, MapDirectionsRenderer, MapGroundOverlay, MapHeatmapLayer, MapInfoWindow, MapKmlLayer, MapMarker, MapAdvancedMarker, MapMarkerClusterer, MapPolygon, MapPolyline, MapRectangle, MapTrafficLayer, MapTransitLayer]
});
